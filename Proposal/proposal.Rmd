...
During the main phase of our project, the actual analysis for possibly existing positive/negative correlations between the extracted Twitter posts and the NBA player performance data is to be done. The data needs to be assessed for relevant variables, expressing the behaviours we want to observe and \newline 
...
To test whether our initial research question holds true, a hypothesis testing needs to be done. For this purpose, the correlations found in the phase before need to be checked for significance by using two possible solutions: Either a Chi-Square test and/or a Two-Proportion Z-test can be used for this. The main reason for considering not only one significance test is… \newline 

Steps:

- Testing if and which of the hypotheses that we proclaimed beforehand holds, based on our correlation analysis results 
- Statistical testing of the results’ significance with Chi-Square test and/or Two-Proportion Z-test \newline 
