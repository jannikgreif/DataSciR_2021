...
```{r display_sentiment_aggregates_24h_before_games, eval = FALSE, message = TRUE}
...
```{r plot_density_curves_avg_sentiments, eval = FALSE, fig.width = 10, fig.height = 30}
player_metadata %>% 
...
```{r plot_qq_plot_avg_sentiments, eval = FALSE, fig.width = 10, fig.height = 30}
player_metadata %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
...
```{r plot_qq_plot_avg_weighted_sentiments, eval = FALSE, fig.width = 10, fig.height = 30}
player_metadata %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
...
```{r plot_density_curves_weighted_rel_freq_negative, eval = FALSE, fig.width = 10, fig.height = 30}
player_metadata %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
...
```{r plot_qq_plot_BPM, eval = FALSE, fig.width = 10, fig.height = 30}
player_metadata %>% 
...
```{r plot-boxplot-BPM, eval = FALSE, fig.width = 10}
player_metadata %>% 
  inner_join(player_game_stats) %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
...
```{r plot_relationship_avg_sentiments_BPM, eval = FALSE, fig.width = 10, fig.height = 35}
player_metadata %>% 
  inner_join(player_game_stats) %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
...
```{r plot_word_clouds_extreme_sentiments, eval = FALSE, fig.width = 10, fig.height = 35}
...
rel_word_frequencies %>% 
  ...
  ggplot(mapping = aes(label = word, size = rel_freq_scaled, color = rel_freq_color)) + 
    ...
    facet_grid(Player ~ extreme_type, scales = "free", space = "free") +
    theme_minimal()
```
...
```{r plot_relationship_weighted_avg_sentiments_BPM, eval = FALSE, fig.width = 10, fig.height = 35}
player_metadata %>% 
  inner_join(player_game_stats) %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
...
```{r plot_relationship_rel_freq_negative_tweets_BPM, eval = FALSE, fig.width = 10, fig.height = 35}
player_metadata %>% 
  inner_join(player_game_stats) %>% 
  inner_join(sentiment_aggregates_24h_before_games) %>% 
