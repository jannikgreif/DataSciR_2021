...
metadata %>% write_csv("data/player-metadata.csv")
```

```{r show-player-metadata}
player_metadata <- read_csv("data/player-metadata.csv")
...
```{r player-season-stats, eval = FALSE}
...
```{r show-player-season-stats}
player_season_stats <- read_csv("data/player-season-stats.csv")
...
```{r player-game-stats, eval = FALSE}
...
player_game_stats %>% write_csv("data/player-game-stats.csv")
```

```{r show-player-game-stats}
player_game_stats <- read_csv("data/player-game-stats.csv")
...
game_metadata %>% write_csv("data/game-metadata.csv")

```

```{r show-game-metadata}
game_metadata <- read_csv("data/game-metadata.csv")
